...
public partial class VtSample : Form
{
	...
	private void VtSample_Load(object sender, EventArgs e)
	{
		...
		Left = Top = 0;
		Size = PrimaryScreen.WorkingArea.Size; //primary screen static using static System.Windows.Forms.Screen; üzerinden calisir
		...
		SplitContainer splitContainer = new(); //Bölücü
		splitContainer.Orientation = Orientation.Horizontal; //Bölme islemini yatayda yapacak
		splitContainer.Dock = DockStyle.Fill;
		Controls.Add(splitContainer);
		_bindingNavigator = new(true); //Formda gezme özelligi
		_bindingSource = new();
		...
		_dataGridView.AutoResizeColumns(); // Sutunlar otomatik boyutlansýn
		...
		string directoryInfo = //StarupPath ise applýcation sinifina ait o da static
			//parent parent parent olma sebebi dosya yolundan eksilterek ilerlememiz cd.. gibi.
			GetParent(StartupPath).Parent.Parent.Parent.FullName; //Get parent directory info sýnýfýna ait static bir sýnýfoldugu icin yukarýda tanýmladýk.
	...
	private void ToolStripButton_Click(object sender, EventArgs e)
	{
		...
		//String bir deger gonderdigimizde like ile arama yapýyoruz 
